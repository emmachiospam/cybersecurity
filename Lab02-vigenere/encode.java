...
public class encode{
  ...
  public static String encrypt(String original, String key) throws FileNotFoundException {
  ...
  public static String encodeFile(String plainTextFile, String keyTextFile) throws FileNotFoundException {
    ...
    try{
      ...
      while(s.hasNext()) {
        line = s.nextLine();
        result = result + encrypt(line, key);
      }
    }
  ...
  public static void main(String[] args) throws FileNotFoundException {
    if(args.length != 2) {
      System.out.println("please input two arguments, the file of text to encode and the file with the key");
    }
    else {
      String encryptFile = args[0];
      String keyFile = args[1];
      try{
        System.out.println(encodeFile(encryptFile, keyFile));
      }
      catch (FileNotFoundException e) {
        System.out.println("file not found");
      }
