...
public class decodeString{
  ...
  public static double[] distance(String crypted, String reference) throws FileNotFoundException {
    ...
    try{
      ...
      double[] encrypted = frequencyString (crypted);
      for(int k = 0; k < 26; k++) {
  ...
  public static double[] frequency (String fileName) throws FileNotFoundException {
    ...
    public static double[] frequencyString (String line) {
      double[] amount = new double[27];
      double[] result = new double[27];
      result = findFrequency(line, amount);
      return result;
  ...
  public static String decode(String line, String reference) throws FileNotFoundException{
    int shift = smallest(distance(line, reference));
    String result = "";
